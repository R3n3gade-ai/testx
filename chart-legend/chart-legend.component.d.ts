...
import { LegendContainerRefHolder, SecondarySeriesRefHolder, SeparateVolumeRefHolder, StudiesRefsHolder } from '../../dom-mutation-models/chart-legend.dom-mutation-model';
...
export interface ChartLegendDMProps {
    ...
    readonly stackedStudySeries: StudiesRefsHolder;
    readonly separatedStudySeries: StudiesRefsHolder;
