...
export declare const chartLayout2ChartInfo: (layout: ChartLayout, instrument: Instrument['symbol'] | undefined, defaultStudies: TStudySettings[], aggregation: AggregationPeriod, timezone: string | undefined) => ChartInfo;
/**
