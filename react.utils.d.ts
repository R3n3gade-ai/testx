...
export declare const useObservableEffects: (effects: Observable<unknown>, skip?: boolean) => void;
export declare const EmptyComponent: React.MemoExoticComponent<() => React.FunctionComponentElement<{
...
export declare const react: {
    ...
    useObservableEffects: (effects: Observable<unknown>, skip?: boolean) => void;
    ...
    typedMemo: <T>(c: T) => T;
    EmptyComponent: React.MemoExoticComponent<() => React.FunctionComponentElement<{
        children?: React.ReactNode;
    }>>;
};
