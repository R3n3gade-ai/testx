...
export interface ChartServiceData {
    data: Either<Error, ChartCandleData[]>;
    instrument: string;
    type: CandleDataType;
}
...
export interface MultiChartDataService {
     ...
     */
    readonly subscribeLastCandleUpdates: (symbols: NonEmptyArray<string>, aggregation: AggregationPeriod, options: ChartDataOptions, chartId: string) => Observable<{
