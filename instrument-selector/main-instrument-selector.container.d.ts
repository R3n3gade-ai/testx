...
export declare const MainInstrumentSelectorContainer: import("../../../context/context2").Context<Record<"chartDataViewModel", ChartDataViewModel> & Record<"instrumentSelectorViewModel", InstrumentSelectorViewModel> & Record<"chartReactConfig", ChartReactConfig>, React.MemoExoticComponent<() => React.FunctionComponentElement<{
