...
import { ProtectionOrderType, OrderSide, VisualOrder, OrderType, OrderId } from '../../model/trading/order.model';
...
export interface TradingViewModel {
    ...
    onPositionDblClick: (id: string) => void;
    onPositionDblClickEventRegister: (callback: (chartId: string, position: VisualPosition) => void) => UnsubscribeCallback;
    onPositionClickEventRegister: (callback: (chartId: string, position: VisualPosition) => void) => UnsubscribeCallback;
    ...
    createOcoOrders: (orderId: OrderId) => void;
    closePositionWithOcoOrders: (positionId: Position['id']) => void;
}
