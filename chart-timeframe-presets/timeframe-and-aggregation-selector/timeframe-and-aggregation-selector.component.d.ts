...
export declare const TimeframeAggregationSelectorComponent: React.MemoExoticComponent<(props: TimeframeAggregationSelectorComponentProps) => React.JSX.Element>;
export {};
