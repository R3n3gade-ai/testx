...
import { BackgroundMenuProps } from '../components/background-menu/background-menu.component';
import { LegendMenuProps } from '../components/chart-legend/chart-legend-menu.component';
import { ChartToolbarProps } from '../components/chart-toolbar/chart-toolbar.component';
import { CompareChartSuggestComponentProps } from '../components/compare-chart/compare-chart-selector.component';
import { DataMenuProps } from '../components/data-menu/data-menu.component';
import { DrawingsMenuProps } from '../components/drawings/drawings-menu/drawings-menu.component';
import { StudiesMenuContentProps } from '../components/studies/studies-menu/studies-menu-content.component';
import { OrderMenuProps } from '../components/trading/order-menu.component';
import { PositionMenuProps } from '../components/trading/position-menu.component';
...
import { YAxisConfiguratorPopoverProps } from '../components/yAxis-settings/yaxis-configurator-popover.component';
import { IconsConfig } from '../../config/icons/icons-config';
import { ChartFooterProps } from '../components/chart-footer/chart-footer.component';
import { TimeZoneDropdownProps } from '../components/time-zone/time-zone-dropdown.component';
import { TimeframePresetsProps } from '../components/chart-timeframe-presets/timeframe-presets.component';
import { ChartLegendHeaderProps } from '../containers/chart-legend/chart-legend.container';
import { SwitchAxisButtonsProps } from '../components/switch-axis-type-button-container/SwitchAxisTypeButtonContainer.component';
import { ChartZoomingToolProps } from '../components/chart-zooming-tool/chart-zooming-tool.component';
import { DrawingSidebarProps } from '../components/chart-sidebar/chart-drawings-sidebar.component';
import { DrawingsSidebarHeaderProps } from '../components/chart-sidebar/chart-drawings-sidebar-header.component';
import { DrawingsSidebarFooterProps } from '../components/chart-sidebar/chart-drawings-sidebar-footer.component';
import { OrderEntryProps } from '../components/trading/order-entry/order-entry.component';
import { PositionProps, PositionPropsAlt } from '../components/trading/order/position.component';
import { ProtectionOrderAltProps, ProtectionOrderProps } from '../components/trading/order/protection-order.component';
import { RegularOrderAltProps, RegularOrderProps } from '../components/trading/order/regular-order.component';
import { GroupOrderProps } from '../components/trading/order/group-order.component';
import { NotificationsComponentProps } from '../components/notifications-component/notifications.component';
export interface ChartReactAPIProps {
    readonly chartReactAPI: ChartReactAPI;
    readonly chartId: string;
}
export interface OverrideProps<T> {
    readonly chartReactAPIProps: ChartReactAPIProps;
    readonly originalProps: T;
}
export interface RCMenuOverrideProps<T> extends OverrideProps<T> {
}
export interface UIOverrides {
    rightClickMenus: {
        yAxisMenu: ComponentType<RCMenuOverrideProps<YAxisConfiguratorPopoverProps>>;
        backgroundMenu: ComponentType<RCMenuOverrideProps<BackgroundMenuProps>>;
        studiesMenu: ComponentType<RCMenuOverrideProps<StudiesMenuContentProps>>;
        drawingsMenu: ComponentType<RCMenuOverrideProps<DrawingsMenuProps>>;
        orderMenu: ComponentType<RCMenuOverrideProps<OrderMenuProps>>;
        positionMenu: React.FC<RCMenuOverrideProps<PositionMenuProps>>;
        legendMenu: ComponentType<RCMenuOverrideProps<LegendMenuProps>>;
        dataMenu: ComponentType<RCMenuOverrideProps<DataMenuProps>>;
    };
    Logo: ComponentType<LogoProps>;
    ChartSettingsTabs: TabDeclaration[];
    SnapshotMenuItems: SnapshotMenuItemDeclaration[];
    ColorPickerComponent: ComponentType<CKColorPickerProps>;
    Toolbar: {
        ToolbarButtons: Array<ToolbarButtonDeclaration>;
        ToolbarContainer: Element;
        ToolbarComponent: ComponentType<ChartToolbarProps>;
        CompareChartSuggest: ComponentType<CompareChartSuggestComponentProps>;
    };
    DrawingsSidebar: {
        DrawingsSidebarComponent: ComponentType<OverrideProps<DrawingSidebarProps>>;
        DrawingsSidebarHeader: ComponentType<OverrideProps<DrawingsSidebarHeaderProps>>;
        DrawingsSidebarFooter: ComponentType<OverrideProps<DrawingsSidebarFooterProps>>;
    };
    Footer: {
        FooterComponent: ComponentType<OverrideProps<ChartFooterProps>>;
        TimeZoneComponent: ComponentType<OverrideProps<TimeZoneDropdownProps>>;
        TimeframePresetsComponent: ComponentType<OverrideProps<TimeframePresetsProps>>;
        DrawingGroupsDropdown: ComponentType<OverrideProps<TimeframePresetsProps>>;
        SwitchAxisButtonsProps: ComponentType<OverrideProps<SwitchAxisButtonsProps>>;
    };
    InstrumentSuggest: ComponentType<InstrumentSuggestComponentProps>;
    NotificationsComponent: ComponentType<NotificationsComponentProps>;
    Legend: {
        Header: ComponentType<OverrideProps<ChartLegendHeaderProps>>;
    };
    ChartZoomingTool: ComponentType<OverrideProps<ChartZoomingToolProps>>;
    OutsideContainer: {
        Popup: Element;
        Popover: Element;
    };
    trading: {
        RegularOrder: ComponentType<OverrideProps<RegularOrderProps>>;
        ProtectionOrder: ComponentType<OverrideProps<ProtectionOrderProps>>;
        Position: ComponentType<OverrideProps<PositionProps>>;
        OrderEntry: ComponentType<OverrideProps<OrderEntryProps>>;
        GroupOrder: ComponentType<OverrideProps<GroupOrderProps>>;
        RegularOrderAlt: ComponentType<OverrideProps<RegularOrderAltProps>>;
        ProtectionOrderAlt: ComponentType<OverrideProps<ProtectionOrderAltProps>>;
        PositionAlt: ComponentType<OverrideProps<PositionPropsAlt>>;
    };
    icons: IconsConfig;
}
export declare function useUIOverride<T1 extends keyof UIOverrides, T2 extends keyof UIOverrides[T1], T3 extends keyof UIOverrides[T1][T2]>(path: [T1, T2, T3]): UIOverrides[T1][T2][T3] | undefined;
...
export declare function useUIOverrideComponent<T1 extends keyof UIOverrides, T2 extends keyof UIOverrides[T1]>(path: [T1, T2], originalProps: unknown): JSX.Element | undefined;
export declare function useUIOverrideComponent<T extends keyof UIOverrides>(path: [T], originalProps: unknown): JSX.Element | undefined;
export declare function useIcons(): {
    ...
    toolbar: {
        ...
        multichart: {
            settings: {
                ...
                onebyone: React.FunctionComponentElement<any>;
                onebytwo: React.FunctionComponentElement<any>;
                twobyone: React.FunctionComponentElement<any>;
                onebythree: React.FunctionComponentElement<any>;
                threebyone: React.FunctionComponentElement<any>;
                twobytwo: React.FunctionComponentElement<any>;
                twobyfour: React.FunctionComponentElement<any>;
            };
        };
        ...
        marketState: React.FunctionComponentElement<any>;
    };
    sidebar: {
    ...
    trading: {
        ...
        createOCO: React.FunctionComponentElement<any>;
    };
    indicatorList: {
        add: React.FunctionComponentElement<any>;
    };
    ...
    drawings: {
        drawingsTypes: {
            ...
            rangeVolumeProfile: React.FunctionComponentElement<any>;
            anchoredVolumeProfile: React.FunctionComponentElement<any>;
        };
        settingsToolbar: {
...
export declare const mergeUIOverrides: <D extends Record<string, any>, O extends DeepPartialOnlyRecord<D>>(defaults: D, uiOverrides: O) => D;
export type UiOverridesContext = DeepPartialOnlyRecord<Omit<UIOverrides, 'icons'>> & {
    icons: UIOverrides['icons'];
};
export declare const UIOverridesContext: React.Context<UiOverridesContext>;
