...
export declare const mapScriptParams: (response: SuccessCompileResponse) => TStudyParameter[];
export declare const mapScriptLines: (response: SuccessCompileResponse, colorsPool: ColorsPool) => TStudyLine[];
