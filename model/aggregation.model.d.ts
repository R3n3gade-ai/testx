...
export declare const periodToMs: (period: AggregationPeriod) => number;
...
export declare const getPeriodLongString: (period: AggregationPeriod, localization: AggregationPeriodDictionary) => string;
export declare const getPeriodShortString: (period: AggregationPeriod, localization: AggregationPeriodDictionary) => string;
export {};
